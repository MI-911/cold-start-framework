...
def download_ratings(path):
    ...
    # ratings?versions=100k,100k-newer,100k-fix,thesis-ppr&final=yes
    urlretrieve(f'{BASE_URL}/ratings?versions=100k,100k-newer,100k-fix,thesis,thesis-ppr,thesis-launch&final=yes', ratings)
